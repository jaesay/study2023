...
public class AsyncCacheAspect {
  ...
  @Pointcut("@annotation(com.example.webfluxcacheable.cache.AsyncCacheable)")
  ...
  public Object around(ProceedingJoinPoint joinPoint) throws Throwable, CacheException {
    ...
    String methodHash = String.format("%s", method.hashCode());
          ...
          Mono.defer(
              () -> {
                try {
                  ...
                  return Mono.error(
                      new CacheException("Error processing async cache with Mono", th));
                }
              });
            ...
            Flux.defer(
                () -> {
                  try {
                    ...
                    return Mono.error(
                        new CacheException("Error processing async cache with Flux", th));
                  }
                }));
