package com.example.springreactive.chapter19.exception;

import com.example.springreactive.chapter19.book.ErrorResponse;
...
public class GlobalWebExceptionHandler implements ErrorWebExceptionHandler {
  ...
  private Mono<Void> handleException(ServerWebExchange serverWebExchange, Throwable throwable) {
    ...
    if (throwable instanceof BusinessLogicException) {
      ...
      serverWebExchange.getResponse().setStatusCode(HttpStatus.valueOf(exceptionCode.getStatus()));
